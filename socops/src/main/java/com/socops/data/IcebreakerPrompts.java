...
/**
 * Central catalogue of every icebreaker prompt that can appear on a board. Exactly 24 entries — one
 * fewer than the 25-cell grid, because the centre cell is always the free space.
 */
public final class IcebreakerPrompts {

  public static final String FREE_CELL_LABEL = "FREE SPACE";

  public static final List<String> ALL_PROMPTS =
      List.of(
          "bikes to work",
